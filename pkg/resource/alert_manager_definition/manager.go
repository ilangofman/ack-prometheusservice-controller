...
// +kubebuilder:rbac:groups=prometheusservice.services.k8s.aws,resources=alertmanagerdefinitions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=prometheusservice.services.k8s.aws,resources=alertmanagerdefinitions/status,verbs=get;update;patch
...
type resourceManager struct {
	...
	sdkapi svcsdkapi.PrometheusServiceAPI
}
...
func (rm *resourceManager) ARNFromName(name string) string {
	return fmt.Sprintf(
		"arn:aws:prometheusservice:%s:%s:%s",
		rm.awsRegion,
		rm.awsAccountID,
		name,
	)
